...
class AssessmentServiceTest {
    ...
    void testCreateAssignment_TitleExists_ThrowsException() {
        ...
        assertEquals("Assignment title already exists", exception.getMessage());
    }
    ...
    void testGetAssessmentsByUser_Success() {
        ...
        List<Map<String, Object>> result = assessmentService.getAssessmentsByUser("instructor");

        assertTrue(result.stream().flatMap(map -> map.values().stream())
                .anyMatch(value -> "Assessment 1".equals(value)));
        assertTrue(result.stream().flatMap(map -> map.values().stream())
                .anyMatch(value -> "Assessment 2".equals(value)));
    }
    ...
    void testSubmitAssignment_AlreadySubmitted_ThrowsException() {
        ...
        assertEquals("208 ALREADY_REPORTED \"Assingment is submitted once\"", exception.getMessage());
    }
    ...
    @Test
    void testSubmitQuiz_MissingQuestionOrder_ThrowsException() {
        Quiz quiz = new Quiz();
        quiz.setTitle("Java Quiz");
        ...
        Question question1 = new Question();
        question1.setQuestionOrder(null);
        question1.setCorrectAnswer("Programming Language");
